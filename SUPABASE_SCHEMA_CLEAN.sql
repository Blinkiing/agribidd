-- Farm Fresh Connect - Clean Rebuild Schema
-- Drop all existing objects and rebuild from scratch without errors
-- This script handles all dependencies and prevents conflicts
