-- Farm Fresh Connect - Schema Without RLS
-- Drop all existing objects and rebuild from scratch
-- NO ROW LEVEL SECURITY POLICIES - PUBLIC ACCESS TO ALL DATA

-- ============================================================
-- STEP 1: DROP ALL STORAGE POLICIES (RLS - must drop first)
-- ============================================================
...
-- ============================================================
-- STEP 2: DROP ALL TABLE RLS POLICIES (if any exist)
-- ============================================================
...
ALTER TABLE IF EXISTS auction_bids DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS escrow_transactions DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS notifications DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS featured_products DISABLE ROW LEVEL SECURITY;
...
-- ============================================================
-- STEP 12: CREATE SELLER PROFILES TABLE
-- ============================================================
...
-- ============================================================
-- STEP 13: CREATE CATEGORIES TABLE
-- ============================================================
...
-- ============================================================
-- STEP 16: CREATE AUCTION BIDS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 18: CREATE ORDER ITEMS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 20: CREATE CART ITEMS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 22: CREATE WALLET TRANSACTIONS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 23: CREATE ESCROW TRANSACTIONS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 24: CREATE NOTIFICATIONS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 25: CREATE FEATURED PRODUCTS TABLE
-- ============================================================
...
-- ============================================================
-- STEP 26: CREATE HERO SLIDES TABLE
-- ============================================================
...
-- ============================================================
-- STEP 30: SET UP STORAGE BUCKETS
-- ============================================================
...
-- ============================================================
-- All tables, functions, triggers, and indexes created successfully.
-- NO RLS POLICIES - Database is open for public access.
-- Storage buckets created with public=true for full public access.
-- This is a development/testing setup without access restrictions.
